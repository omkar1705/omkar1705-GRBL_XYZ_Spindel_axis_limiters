...
ISR(TIMER1_COMPA_vect)
{
  ...
  if (st.counter_x > st.exec_block->step_event_count) {
    ...
    if (st.exec_block->direction_bits & (1<<X_DIRECTION_BIT)) { 
      ...
      if (costyx==1)   PORTD = (PORTD & 0B11000011) | 0B100000;
      if (costyx==2)   PORTD = (PORTD & 0B11000011) | 0B110000;
      if (costyx==3)   PORTD = (PORTD & 0B11000011) | 0B010000;
      if (costyx==4)   PORTD = (PORTD & 0B11000011) | 0B011000;
      if (costyx==5)  PORTD = (PORTD & 0B11000011) | 0B001000;
      if (costyx==6)  PORTD = (PORTD & 0B11000011) | 0B001100;
      if (costyx==7)  PORTD = (PORTD & 0B11000011) | 0B000100;
      if (costyx==8) PORTD = (PORTD & 0B11000011) | 0B100100;
    } else { 
      sys_position[X_AXIS]++; 
      costyx=costyx+1;
  ...
  if (st.counter_y > st.exec_block->step_event_count) {
    ...
    if (st.exec_block->direction_bits & (1<<Y_DIRECTION_BIT)) { 
      ...
      if (costyy==1)   PORTC = (PORTC & 0B11110000) | 0B1000;
      if (costyy==2)   PORTC = (PORTC & 0B11110000) | 0B1100;
      if (costyy==3)   PORTC = (PORTC & 0B11110000) | 0B0100;
      if (costyy==4)   PORTC = (PORTC & 0B11110000) | 0B0110;
      if (costyy==5)  PORTC = (PORTC & 0B11110000) | 0B0010;
      if (costyy==6)  PORTC = (PORTC & 0B11110000) | 0B0011;
      if (costyy==7)  PORTC = (PORTC & 0B11110000) | 0B0001;
      if (costyy==8) PORTC = (PORTC & 0B11110000) | 0B1001;
    } else { 
      sys_position[Y_AXIS]++;
      costyy=costyy+1;
  ...
  if (st.counter_z > st.exec_block->step_event_count) {
    ...
    if (st.exec_block->direction_bits & (1<<Z_DIRECTION_BIT)) { 
      ...
      if (costyz==1)   PORTB = (PORTB & 0B00001100) | 0B100000;
      if (costyz==2)   PORTB = (PORTB & 0B00001100) | 0B110000;
      if (costyz==3)   PORTB = (PORTB & 0B00001100) | 0B010000;
      if (costyz==4)   PORTB = (PORTB & 0B00001100) | 0B010010;
      if (costyz==5)  PORTB = (PORTB & 0B00001100) | 0B000010;
      if (costyz==6)  PORTB = (PORTB & 0B00001100) | 0B000011;
      if (costyz==7)  PORTB = (PORTB & 0B00001100) | 0B000001;
      if (costyz==8) PORTB = (PORTB & 0B00001100) | 0B100001;
    } else { 
      sys_position[Z_AXIS]++;
      costyz=costyz+1;
